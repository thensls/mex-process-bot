...
| Contact | Purpose |
|---|---|
| support@nsls.org | MEX inbox — order confusion, FAQ support, transcript navigation |
| advising@nsls.org | Online chapter advising — all advising inquiries |
| kimberlyjcampbell@nsls.org | Whale school (strategic partner) advising — direct contact for Kimberly |
| registrar@nsls.org | Credit questions, course changes, legacy programs (managed by Whitney Jett) |
| inductions@nsls.org | Induction kit requests, replacements, shipping |
| shop@nsls.org | Shop inquiries (no existing order) |
| kprentiss@nsls.org | Ignite product questions — Kevin Prentiss, Head of Product |
| events@nsls.org | NSLS Summit inquiries |

### Slack Channels for Escalation

| Channel | Purpose |
|---|---|
| `#mex-sos-escalations` | Escalate to SOS Specialist or Team Lead for advice |
| `#mex-help-desk` | Tech team ticket requests, data removal notifications |

### Bot Training & SOP Team

| Role | Name(s) | Responsibility |
|---|---|---|
| Bot Trainer | Atrayu, Kara, Kimberly Campbell | Training and refining Coach Max's responses |
| SOP Author | Nancy Castillo | Writing and maintaining SOP documentation |
| SOS Management | Monica Cerrato | SOS escalation process oversight |
