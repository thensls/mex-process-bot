...
Drop the Slack canvas (already drafted) into `#mex-sos-escalations` with the one-line post: *"Coach Max correction loop — what changes + what you'll need to do: <CANVAS_LINK>"*. Pin it.
